# OWASP AI Testing Guide — Test Case Catalog

The 32 OWASP AI Testing Guide v1 test cases, grouped by layer. Each case lists its
objective, payloads/procedure, observable responses, severity guidance, and remediation.
Load the layer section you are testing (see `SKILL.md` → "Test Cases").

## Contents

- [Quick Reference (priority index)](#quick-reference-priority-index)
- [Layer 1: AI Application Testing (AITG-APP)](#layer-1-ai-application-testing-aitg-app)
- [Layer 2: AI Model Testing (AITG-MOD)](#layer-2-ai-model-testing-aitg-mod)
- [Layer 3: AI Infrastructure Testing (AITG-INF)](#layer-3-ai-infrastructure-testing-aitg-inf)
- [Layer 4: AI Data Testing (AITG-DAT)](#layer-4-ai-data-testing-aitg-dat)
