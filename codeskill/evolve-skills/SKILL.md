...
3. **记录**：说明触发场景、改了哪个文件、为何改。
4. **同步**（**必须**跑脚本，codeskill 会部署到 `~/.claude/skills/` 并链接各端）：
...
- [ ] codeskill 改在 `~/Documents/code/skill/codeskill/`；其余改在 `~/.claude/skills/`
- [ ] `description` 含触发条件
- [ ] 无密钥 / 无项目私有路径硬编码
